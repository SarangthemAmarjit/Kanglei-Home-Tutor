...
class UserhomescreenPage extends StatefulWidget {
  ...
  @override
  State<UserhomescreenPage> createState() => _HomePageState();
}

class _HomePageState extends State<UserhomescreenPage> {
  String userna = '';
            ...
            slivers: <Widget>[
              SliverLayoutBuilder(builder: (context, constraints) {
                ...
                return SliverAppBar(
                    ...
                    expandedHeight: MediaQuery.of(context).size.height < 833
